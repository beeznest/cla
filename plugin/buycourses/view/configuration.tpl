...
<div class="tab-content">
    {% if not show_services_only %}
        <div role="tabpanel" class="tab-pane {{ show_services_only ? '' : 'fade in active' }}" id="courses">
        ...
        {% endif %}
    {% endif %}
    <div role="tabpanel" class="tab-pane {{ show_services_only ? 'fade in active' : '' }}" id="services">
        <div class="table-responsive">
