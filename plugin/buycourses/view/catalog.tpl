                                ...
                                <div class="col-md-4 col-sm-6">
                                    <article class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <div class="text-center">
                                                <a class="btn btn-success buy-courses-block-button" title="" href="{{ _p.web_plugin ~ 'buycourses/src/service_process.php?' ~ {'i': service.id, 't': service.applies_to}|url_encode() }}">
                                                    <em class="fa fa-shopping-cart"></em> {{ 'Buy'|get_plugin_lang('BuyCoursesPlugin') }}
                                                </a>
                                            </div>
                                        </div>
