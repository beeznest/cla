...
$strings['CautionThisProcessCantBeCancelled'] = "<b>Attention</b>: ce processus peut prendre quelques minutes et ne peut pas être interrompu.";
...
$strings['PayoutStatusCancelled'] = "Paiement annulé";
...
$strings['Renewable'] = "Renouvelable";
$strings['TheUserIsAlreadyOwnThisService'] = "Vous avez déjà acheté ce Service.";
$strings['AppliesTo'] = "S'applique à";
$strings['AdditionalInfo'] = "Information additionnelle";
$strings['PleaseSelectTheCorrectInfoToApplyTheService'] = "Veuillez sélectionnez les informations correctes pour appliquer le service";
$strings['MyServices'] = "Mes Services";
$strings['NewService'] = "Nouveau Service";
$strings['EditService'] = "Service édition";
$strings['StartDate'] = "Date de Début";
$strings['EndDate'] = "Date de Fin";
$strings['SubscriptionToServiceXSuccessful'] = "Votre abonnement au service \"%s\" est confirmé.";
$strings['ServicePayPalPaymentOKPleaseConfirm'] = "PayPal nous indique que la transaction est prête à être exécutée. Par mesure de sécurité, nous vous demandons de bien vouloir confirmer une dernière fois la transaction en cliquant sur le bouton de confirmation ci-dessous. Une fois cliqué, le service sera activé, et les fonds correspondants seront soustraits de votre compte PayPal. Merci de votre fidélité!";
$strings['EnableService'] = "Activer le Service";
$strings['ServiceType'] = "Type de Service";
...
$strings['AdditionalInfoRequired'] = "Sélectionnez le plus d'infos";
$strings['SubscriptionPackage'] = "Paquet d'abonnements";
$strings['EnterTheMaxSubscribersForThisService'] = "Entrez le numéro maximum d'abonnés pour ce service";
$strings['PackageName'] = "Nom du paquet";
$strings['StoreName'] = "Nom du boutique";
$strings['ServiceInformation'] = "Informations de service";
$strings['HottestSubscriptions'] = "Abonnements les plus populaires";
$strings['GoAheadAndBrowseOurStoreCatalogOnceBuyYouCanAccessToServicesPanelToManage'] = "Allez-y et parcourir notre magasin afin que vous puissiez acheter ce que vous voulez, l'étape suivante peut voir vos achats sur le panneau des services";
$strings['ServiceCatalog'] = "La catalogue des services";
$strings['AutoBilling'] = "Facturation automatique";
$strings['Register'] = "Registre";
$strings['RegisterSubscriptors'] = "Register Abonnés";
