...
{% block body %}
        ...
        {% if section_name == 'section-mycampus' and hide_special_search_block == 0 %}
            <section id="hero">
                <div class="container">
                    ...
                    <p class="description">Apúntate a nuestros cursos online y evoluciona en tus conocimientos
                        #AtreveteHoy</p>
                    {% if _u.logged == 0 %}
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#register_modal"
    ...
    {% if section_name == 'section-mycampus' %}
        <section id="extra-focus" class="text-center" style="padding-bottom: 30px;">
            <div class="container">
                <a href="{{ _p.web_main }}auth/courses.php" class="btn btn-primary"><i class="fa fa-book"></i> Ver más
                    cursos en Chamila</a>
            </div>
        </section>
