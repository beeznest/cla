    ...
    <div class="btn-group">
        ...
        {% if allowDrhSkillsManagement %}
            <a class="btn btn-default"
               href="{{ _p.web_main }}admin/skills_wheel.php">{{ 'ManageSkills'|get_lang }}</a>
        {% endif %}
    </div>
{% endif %}
...
<div class="row">
    ...
    <div class="col-md-6">
        <form class="form-inline" method="post" action="{{ _p.web_self }}">
            ...
            <button type="submit" class="btn btn-default"><em class="fa fa-filter"></em>{{ 'Filter'|get_lang }}
            </button>
        </form>
    </div>
</div>

<h2 class="page-header">{{ reportTitle }}
