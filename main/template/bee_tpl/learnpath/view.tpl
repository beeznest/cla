<div id="learning_path_main"
    ...
    <div id="lp_navigation_elem" class="navegation-bar">
        <a href="#" title="{{ 'Expand'|get_lang }}" id="lp-view-expand-toggle" class="icon-toolbar expand"
           role="button">
        ...
        <a id="home-course" title="{{ 'Home'|get_lang }}" href="{{ button_home_url }}" class="icon-toolbar"
                ...
                <div id="navTabsbar" class="nav-tabs-bar">
                    <ul id="navTabs" class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#lp-view-content" title="{{ 'Lesson'|get_lang }}" aria-controls="lp-view-content"
                        ...
                        <li role="presentation">
                            <a href="#lp-view-forum" title="{{ 'Forum'|get_lang }}" aria-controls="lp-view-forum"
                               role="tab" data-toggle="tab">
