                        ...
                        <div class="items items-hotcourse">
                            <div class="image">
                                <a href="{{ _p.web }}session/{{ session.id }}/about/" title="title-session">
                                    <img class="img-responsive" src="{{ _p.web_upload }}{{ session.image }}" id="session-idsession">
                                </a>
                            ...
                            <div class="description">
                                <div class="block-title">
                                    <h3 class="title">
                                        <a href="{{ _p.web }}session/{{ session.id }}/about/" title="title-session">{{ session.name }}</a>
                                    </h3>
                                </div>
                                <div class="block-author">

                                    <a href="{{ _p.web_main }}inc/ajax/user_manager.ajax.php?a=get_user_popup&user_id={{ session.id_coach }}" class="ajax" data-title="{{ session.firstname }} {{ session.lastname }}">
